...
public class Menu {
    ...
    public void runPurchaseMenu() {
        ...
        while (isRunning) {
            ...
            if (choice.equals("feedMoney")) {
                ...
                audit.write(dateTimeString + " " + "MONEY FED: $" + moneyToAdd + " $" + getBalance());
                ...
                if (item != null && checkIfQuantityIsSufficient(item) && isTheBalanceGreaterOrEqualToItemPrice(item, balance)) {
                    ...
                    audit.write(dateTimeString + " " + item.getItemName() + " " + item.getSlotIdentifier()
                            + " $" + balance.add(item.getPrice()) + " $" + balance);
                ...
                try {
                    ...
                    System.out.println("There was an error closing this file.");
                }
    ...
    public boolean isTheBalanceGreaterOrEqualToItemPrice(Item item, BigDecimal balance) {
        return balance.compareTo(item.getPrice()) == 0 || balance.compareTo(item.getPrice()) == 1;
    }
    ...
    public void changeThatIsGiven() {
        ...
        System.out.println("Change Given: " + dollars + " dollars, " + quarters + " quarters, "
    ...
    public List<Item> readFromFile(String fileName) {
        ...
        try {
            ...
            while (fileScanner.hasNextLine()) {
                ...
                Item itemList = new Item(lineArray[0], lineArray[1], lineArray[2], new BigDecimal(lineArray[3]),
                        items.getQuantity());
