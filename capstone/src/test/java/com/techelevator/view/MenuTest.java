...
public class MenuTest {
    ...
    //tests for isTheBalanceGreaterOrEqualToItemPrice
    @Test
    ...
    //tests for verifyItemIdentifierExists
    @Test
    public void if_item_DoesNot_Exist_should_return_null() {
        //arrange
        String testFileName = "test.csv";
        List<Item> actualResults = testMenu.readFromFile(testFileName);
    ...
    @Test
    public void if_item_doesExist_should_return_item() {
        //arrange
        String testFileName = "test.csv";
        List<Item> actualResults = testMenu.readFromFile(testFileName);
    ...
    //tests for checkIfQuantityIsSufficient
    @Test
    public void if_quantity_is_sufficient_should_return_true() {
        //arrange
        Item testItem = new Item("C1", "Popcorn", "Munchy", new BigDecimal("1.75"), 7);
        boolean expected = true;
        //act
    ...
    @Test
    public void if_quantity_is_not_sufficient_should_return_false() {
        //arrange
    ...
    @Test
    public void if_quantity_is_one_should_return_true() {
        //arrange
